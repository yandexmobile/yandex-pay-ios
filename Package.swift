  ...
  targets: [
    .target(
      ...
      dependencies: [
        ...
        "FintechSDKAppTransportSecurityScenario",
    ...
    .binaryTarget(
      name: "FintechSDKAppTransportSecurityScenario",
      path: "XCFrameworks/FintechSDK/FintechSDKAppTransportSecurityScenario.xcframework"
    ),
    .binaryTarget(
