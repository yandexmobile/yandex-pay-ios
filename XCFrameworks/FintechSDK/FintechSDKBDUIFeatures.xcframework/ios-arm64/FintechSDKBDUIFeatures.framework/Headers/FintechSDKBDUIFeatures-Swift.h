...
@class NSString;
@class NSBundle;
/// Navigation controller for BDUI flows.
/// Encapsulates the standard setup: hidden navigation bar
/// and control of the interactive pop gesture (same pattern as <code>FTPKNavigationController</code>).
SWIFT_CLASS("_TtC22FintechSDKBDUIFeatures26FTBDUINavigationController")
@interface FTBDUINavigationController : UINavigationController
- (void)viewDidLoad;
